...
use Lefeto\ReservationBundle\Entity\Residence;
...
class ResidenceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $residences = $em->getRepository('LefetoReservationBundle:Residence')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Lefeto\ReservationBundle\Form\ResidenceType', $residence);
    ...
    {
        $deleteForm = $this->createDeleteForm($residence);
        $editForm = $this->createForm('Lefeto\ReservationBundle\Form\ResidenceType', $residence);
